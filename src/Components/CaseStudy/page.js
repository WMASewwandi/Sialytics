          ...
          {CardData.map((card, index) => (
            ...
            >
              <Box display="flex" flexDirection={{ xs: "column", md: "row" }} alignItems="center" width="100%">
                <Box sx={{ width: { xs: "100%", md: "40%" }, display: "flex", justifyContent: { xs: "center", md: "flex-start" }, alignItems: "center", p: 2 }}>
                  <img src={card.image} width={70} height={70} alt={card.name} />
                </Box>
                <Box sx={{ width: { xs: "100%", md: "60%" }, p: 2, textAlign: { xs: "center", md: "left" } }}>
